export default {
    data() {
        return {
            ...
            modrost: [
                {
                    tarotKarta: "Kralj kelihov",
                    rekDesno: "Ravnovesje z lahkoto<br>Čustva so disciplinirana<br>Občutljiv, a močan",
                },
            ],
            opisKarte: [
                {
                    opisKarte: '<p>Kralj kelihov sedi na velikem kamnitem prestolu in nosi modro tuniko ter zlato ogrinjalo – simbol njegove avtoritete in statusa. Okoli njegovega vratu visi majhen ribji amulet, ki simbolizira njegovo ustvarjalnost. V desni roki drži kelih, ki predstavlja čustva, v levi pa ima žezlo, ki kaže moč in nadzor. V nasprotju z drugimi kartami tukaj ne gleda svojega keliha in zdi se, da je osredotočen drugam; morda je že obvladal svoj čustveni jaz in se mu ni treba tako močno osredotočati na ta vidik sebe.</p><p>Zdi se, da Kralj kelihov lebdi na granitnem bloku sredi razburkanega morja. Za njim na njegovi desni iz oceana skoči riba, na levi pa kljub valovom vztrajno pluje ladja. Te slike kažejo, da ta kralj ostaja miren in uravnotežen tudi v turbulentnih razmerah in se je naučil ostati odprt za svoja čustva in nezavedne impulze, ne da bi ga ti prevzeli. Ohranja moč in nadzor, hkrati pa uravnoveša svoja čustva.</p>',
            ...
            elementi: [
                ...
                {
                    ime: "Čas:",
                    vrednost: "Konce zime,  konec poletja"
                }
            ],
        }
    }
